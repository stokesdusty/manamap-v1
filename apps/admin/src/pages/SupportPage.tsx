    ...
    >
      <div className="card" style={{ maxWidth: 480, width: '100%', padding: '48px 36px' }}>
        ...
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.6, marginBottom: 24 }}>
          Having trouble with ManaMap? We're happy to help. Reach out and we'll get back to you as
          soon as we can.
        </p>
        ...
        <hr
          style={{ border: 'none', borderTop: '1px solid var(--border-light)', marginBottom: 24 }}
        />
